...
<body>
    ...
    <div class="content content-ar">
        ...
        <div class="sec-2 short" id="short">
            ...
            @foreach(json_decode($text1) as $key=>$value)
            <p>{{$value}}</p>
            @endforeach
        ...
        <div class="sec-3">
            ...
            <div class="flexx">
                <div class="flexx-right plus">
                    <ul class="scrollable-element">
                        @foreach(json_decode($text2) as $key=>$value2)
                        <li>{{$value2}}</li>
                        @endforeach
            ...
            <div class="sec-bottom">
                <div class="flexx-right">
                    <ul class="scrollable-element">
                        @foreach(json_decode($text3) as $key=>$value3)
                        <li>{{$value3}}</li>
                        @endforeach
                    </ul>
                </div>
        ...
        <div class="sec-4" id="news">
            ...
            <div class="flexx-3">
                ...
                <ul class="scrollable-element">
                    @foreach(json_decode($text4) as $key=>$value4)
                    <li>{{$value4}}</li>
                    @endforeach
            ...
            <div class="cards">
                <div class="card card-1 scrollable-element">
                    @foreach(json_decode($text5) as $key=>$value5)
                    <p>{{$value5}}</p>
                    @endforeach
                   
                    
                </div>
                <div class="card card-3 scrollable-element">
                    @foreach(json_decode($text6) as $key=>$value6)
                    <p>{{$value6}}</p>
                    @endforeach
                    
                </div>
                <div class="card scrollable-element">
                    @foreach(json_decode($text7) as $key=>$value7)
                    <p>{{$value7}}</p>
                    @endforeach
        ...
        <div class="sec-5">
            <div class="sec5-top">
                <img src="{{$img8}}" />
                <p class="scrollable-element">{{$text8}}</p>
            </div>
            <p class="pp">{{$text9}}</p>
        </div>
