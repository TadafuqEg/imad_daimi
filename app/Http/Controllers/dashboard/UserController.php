...
{//done
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $all_users = user::where('first_name', 'LIKE', '%' . $request->search . '%')->where('username', 'LIKE', '%' . $request->search . '%')->orWhere('last_name', 'LIKE', '%' . $request->search . '%')->orWhere('email', 'LIKE', '%' . $request->search . '%')->orWhere('phone', 'LIKE', '%' . $request->search . '%')->get();
        } else {
